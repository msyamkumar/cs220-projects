...
expected_json = {
 ...
 {'title': 'Lethal Weapon',
  ...
  'genres': ['Action', 'Crime', 'Thriller']}],
    "12": [{'title': 'Fortitude and Glory: Angelo Dundee and His Fighters',
  'year': 2012,
  'rating': 7.2,
 ...
 'long': [{'title': 'B', 'year': 2018, 'style': 'long', 'genres': ['g2']},
  {'title': 'D', 'year': 2019, 'style': 'long', 'genres': ['g1', 'g2', 'g3']}]},
    "22": {'g1': [{'title': 'A', 'year': 2018, 'style': 'short', 'genres': ['g1']},
  {'title': 'D', 'year': 2019, 'style': 'long', 'genres': ['g1', 'g2', 'g3']}],
 'g2': [{'title': 'B', 'year': 2018, 'style': 'long', 'genres': ['g2']},
  {'title': 'D', 'year': 2019, 'style': 'long', 'genres': ['g1', 'g2', 'g3']}],
 'g3': [{'title': 'C', 'year': 2019, 'style': 'short', 'genres': ['g3']},
  {'title': 'D', 'year': 2019, 'style': 'long', 'genres': ['g1', 'g2', 'g3']}]},
    "23": {2018: [{'title': 'A', 'year': 2018, 'style': 'short', 'genres': ['g1']},
  {'title': 'B', 'year': 2018, 'style': 'long', 'genres': ['g2']}],
 2019: [{'title': 'C', 'year': 2019, 'style': 'short', 'genres': ['g3']},
  {'title': 'D', 'year': 2019, 'style': 'long', 'genres': ['g1', 'g2', 'g3']}]},
    "24": {2003: [{'title': 'Runaway Jury',
   'year': 2003,
   'rating': 7.1,
   'directors': ['Gary Fleder'],
   'actors': ['John Cusack', 'Gene Hackman', 'Dustin Hoffman'],
 ...
 1987: [{'title': 'Lethal Weapon',
   ...
   'genres': ['Action', 'Crime', 'Thriller']}]},
    ...
    "32": {'Robert De Niro': 49,
            ...
            'Bruce Dern': 45,
            'Dean Stockwell': 53},
    "33": {'Howard Hawks': 42, 'Stanley Kubrick': 46},
    ...
    "36": [{'category': 'Horror', 'rating': 5.7, 'count': 85},
    ...
    "38": [{'category': 1962, 'rating': 7.2, 'count': 17},
            ...
            {'category': 1976, 'rating': 7.0, 'count': 17},
            {'category': 1963, 'rating': 6.95, 'count': 10},
            {'category': 1956, 'rating': 6.9, 'count': 30},
            {'category': 1970, 'rating': 6.85, 'count': 12},
            {'category': 1948, 'rating': 6.8, 'count': 21},
            {'category': 1936, 'rating': 6.8, 'count': 13}],
    ...
    "40": [{'category': 'Charles Chaplin', 'rating': 8.149999999999999, 'count': 10},
            {'category': 'Kirk Douglas', 'rating': 7.15, 'count': 12},
            {'category': 'Ward Bond', 'rating': 7.1, 'count': 10},
            {'category': 'Henry Fonda', 'rating': 6.9, 'count': 77},
            {'category': 'Lewis Stone', 'rating': 6.75, 'count': 14},
            {'category': 'Mickey Rooney', 'rating': 6.7, 'count': 82},
            {'category': 'Anthony Quinn', 'rating': 6.7, 'count': 79},
            {'category': 'Brian Donlevy', 'rating': 6.7, 'count': 47},
            {'category': 'Ewan McGregor', 'rating': 6.7, 'count': 29},
            {'category': 'Robert Mitchum', 'rating': 6.65, 'count': 74}],
}
