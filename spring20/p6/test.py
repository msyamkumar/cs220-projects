...
expected_json = {
    "1": 23,
    "2": 84.94203864090606,
    "3": ['Felton Road', 'Kumeu River', 'Spy Valley'],
    "4": ['Merlot',
        'Cabernet Franc',
        'Lemberger',
        'Zinfandel',
    ...
    "6": ['Tempranillo', 'Tinta de Toro', 'Cabernet Sauvignon', 'Castelão', 'Red Blend'],
    ...
    "13": ['Heitz',
        ...
        'Belle Ambiance',
        'Grand Pacific'],
    "14": ['Matias Riccitelli', 'Bodega Las Cañitas'],
    "15": ['Mission Hill', 'Cave Spring'],
    "16": ['Cabernet Franc'],
